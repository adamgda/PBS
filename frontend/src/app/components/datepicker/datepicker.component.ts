    ...
    <div class="mb-3">
      ...
      <div class="relative mt-1.5">
        ...
        <input
          ...
          [min]="min || null"
          [max]="max || null"
          class="block w-full rounded-lg border border-gray-200 bg-white py-2.5 shadow-sm transition-colors focus:border-transparent focus:ring-2 focus:ring-pbs-primary disabled:cursor-not-allowed disabled:bg-gray-100"
          [class.pl-11]="!!icon"
          [class.pl-3]="!icon"
          [class.pr-9]="canClear()"
          [class.pr-3]="!canClear()"
